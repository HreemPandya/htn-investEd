...
const InsightsDashboard = ({ userData, onNext }: InsightsDashboardProps) => {
  ...
  const renderOverviewTab = () => (
    <div className="space-y-8">
      ...
      >
        <h3 className="text-2xl font-bold mb-6" style={{ color: "#23231A" }}>
          🎯 Goals Progress
        </h3>
            ...
            return (
              <div key={goal.id} className="rounded-2xl p-6 bg-white shadow-sm">
                <div className="flex justify-between items-center mb-4">
                  ...
                  >
                    ...
                    >
                      $
                      {Math.round(
                        ((goal.suggestedAmount ?? 0) * progress) / 100
                      ).toLocaleString()}{" "}
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${progress}%`,
                      background:
                        "linear-gradient(90deg, #005DAA 0%, #3B82F6 100%)",
                    }}
                  />
                </div>
                ...
                <div className="flex justify-between text-base">
                  ...
                  <span style={{ color: "#91918D" }}>
                    {totalMonths - monthsElapsed} months remaining
                  </span>
                </div>
              </div>
            );
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="rounded-2xl p-8 shadow-sm text-center bg-white">
          <div className="text-4xl font-bold mb-3" style={{ color: "#10B981" }}>
            ${userData.selectedTier?.monthlyAmount || 0}
          </div>
          <div className="text-lg mb-2" style={{ color: "#23231A" }}>
            Monthly Investment
          </div>
        ...
        <div className="rounded-2xl p-8 shadow-sm text-center bg-white">
          <div className="text-4xl font-bold mb-3" style={{ color: "#005DAA" }}>
        ...
        <div className="rounded-2xl p-8 shadow-sm text-center bg-white">
          <div className="text-4xl font-bold mb-3" style={{ color: "#F59E0B" }}>
            {Math.round(
              ((userData.selectedTier?.monthlyAmount || 0) /
                Number.parseInt(userData.monthlyIncome || "1000")) *
                100
            )}
            %
          </div>
      ...
      <div className="rounded-2xl p-8 shadow-sm bg-white mb-8">
        <div className="text-center">
          ...
          <p className="text-lg mb-6" style={{ color: "#91918D" }}>
            Generate a custom video explaining your spending patterns and
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
          ...
          <div className="text-center p-4 bg-red-50 rounded-xl">
            ...
            <div className="text-xs text-gray-600 mt-1">
              {Math.round((unnecessarySpending / totalSpending) * 100)}% of
              total
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-warm-yellow/10 border border-warm-yellow/30 rounded-xl">
            ...
            <div>
              ...
              <div className="text-sm text-yellow-700">
                You spent 25% on entertainment. Consider reducing by $100/month
          ...
          <div className="flex items-start space-x-3 p-3 bg-growth-green/5 border border-growth-green/30 rounded-xl">
            ...
            <div>
              <div className="font-medium text-green-800">
                Great Transportation Management
              </div>
              <div className="text-sm text-green-700">
                Your transport costs are 15% below average for students in your
                area!
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-rbc-blue/5 border border-rbc-blue/30 rounded-xl">
            ...
            <div>
              ...
              <div className="text-sm text-blue-700">
                Switch to meal prep twice a week to save ~$80/month on dining
                out.
              </div>
            </div>
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <p className="text-gray-600 mb-6">
          Short explainer videos and text about investing basics. Learn at your
          own pace!
        </p>
        ...
        <div className="space-y-3">
          {[
            ...
            >
              ...
              <button className="ml-auto text-rbc-blue text-sm hover:underline">
                Learn More
              </button>
            </div>
          ))}
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="p-6 flex justify-center items-center"></div>
      ...
      <div className="px-6 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #005DAA 0%, #3B82F6 100%)",
            }}
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-white/90 text-lg">
                  Here's your financial overview • {userData.selectedTier?.name}{" "}
                  Plan
                </p>
              </div>
              <div className="text-right">
                ...
                <div className="font-bold text-white text-xl">
                  {userData.goals?.[0]?.name} in{" "}
                  {Number.parseInt(userData.goals?.[0]?.timeline || "0") - 3}{" "}
                  months
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              {tabs.map((tab) => (
                <button
                  ...
                  style={{
                    backgroundColor:
                      activeTab === tab.id ? "#005DAA" : "transparent",
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            <div className="bg-gradient-to-br from-growth-green to-green-600 rounded-xl p-6 text-black">
              <h3 className="text-lg font-semibold mb-2">
                🚀 Want to learn more?
              </h3>
              <p className="text-sm opacity-90 mb-4">
                Explore advanced investing strategies and get personalized
                advice from RBC advisors.
              </p>
              <button className="bg-white bg-opacity-20 text-black px-4 py-2 rounded-xl hover:bg-opacity-30 transition-colors">
                Check this short video for more information! →
              </button>
            </div>

            <div className="bg-gradient-to-br from-rbc-blue to-blue-700 rounded-xl p-6 text-black">
              <h3 className="text-lg font-semibold mb-2">
                💡 Optimize Your Plan
              </h3>
              <p className="text-sm opacity-90 mb-4">
                Based on your progress, we have suggestions to help you reach
                your goals faster.
              </p>
              <button className="bg-white bg-opacity-20 text-black px-4 py-2 rounded-xl hover:bg-opacity-30 transition-colors">
          ...
          <div className="mt-8 text-center text-gray-500">
            <p className="text-sm">
              ...
              <span className="text-rbc-blue hover:underline cursor-pointer">
                {" "}
                Privacy Policy
              </span>
            </p>
